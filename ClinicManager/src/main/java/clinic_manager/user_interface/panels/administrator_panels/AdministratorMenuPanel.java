...
public class AdministratorMenuPanel extends JPanel{
    ...
    public AdministratorMenuPanel(AdministratorApplicationFrame applicationFrame, User user) {
    ...
    private void init(){
        ...
        var tableButton = new MainButton("Users");
        tableButton.setPreferredSize(new Dimension(200, 75));
        tableButton.addActionListener(e -> {
            this.applicationFrame.getAdministratorViewPanel().getProfilePanel().setVisible(false);
            this.applicationFrame.getAdministratorViewPanel().getTablePanel().setVisible(true);
        });
        ...
        profileButton.addActionListener(e -> {
            this.applicationFrame.getAdministratorViewPanel().getTablePanel().setVisible(false);
            this.applicationFrame.getAdministratorViewPanel().getProfilePanel().setVisible(true);
        });
